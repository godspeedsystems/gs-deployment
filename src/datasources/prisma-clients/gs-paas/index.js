...
const config = {
  ...
  "inlineSchemaHash": "2cf5932622f12affb5736902e594b3a4857a83af5d8481174ae5d5e49915850e",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/datasources/prisma-clients/gs-paas",
    "datasources/prisma-clients/gs-paas",
  ]
